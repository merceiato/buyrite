...
class GuideView {
  ...
  render() {
    const guide = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, () => (0, _Router.gotoRoute)("/"));
...
class HaircutsView {
  ...
  render() {
    const buyrite = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser));
    (0, _litHtml.render)(buyrite, _App.default.rootEl);
  }
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/vendorHome.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35167" + '/');

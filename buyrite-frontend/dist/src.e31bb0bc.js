...
function _templateObject5() {
  const data = _taggedTemplateLiteral([" <p>no bio</p> "]);
...
function _templateObject5() {
  const data = _taggedTemplateLiteral([" <input type=\"file\" name=\"avatar\" /> "]);
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format("MMMM Do YYYY, @ h:mm a"), this.updateProfileSubmitHandler.bind(this), this.user.bio, this.user.accessLevel || 1, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5())));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class GuideView {
  ...
  render() {
    const accessLevel = Number(_Auth.default.currentUser && _Auth.default.currentUser.accessLevel);
    const isVendor = accessLevel === 2;
    const guide = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, isVendor ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3()), () => (0, _Router.gotoRoute)(isVendor ? "/vendor" : "/buyrite"));
...
class ProductAPI {
  ...
  async getPublicProducts() {
    const response = await fetch("".concat(_App.default.apiBase, "/product"), {
      method: "GET" // public endpoint – no auth header required
...
class buyriteView {
  ...
  render() {
    ...
    const template = (0, _litHtml.html)(_templateObject2(), JSON.stringify(_Auth.default.currentUser), this.handleSearchInput.bind(this), this.selectedCategory, this.handleCategoryChange.bind(this), this.ethicsStrict ? "primary" : "default", this.handleEthicsYes.bind(this), !this.ethicsStrict ? "primary" : "default", this.handleEthicsNo.bind(this), isLoading ? (0, _litHtml.html)(_templateObject3()) : error ? (0, _litHtml.html)(_templateObject4(), error) : filtered.length === 0 ? (0, _litHtml.html)(_templateObject5(), this.ethicsStrict ? (0, _litHtml.html)(_templateObject6()) : "") : (0, _litHtml.html)(_templateObject7(), filtered.map(p => (0, _litHtml.html)(_templateObject8(), p.image ? (0, _litHtml.html)(_templateObject9(), _App.default.apiBase, p.image, p.title) : "", p.title, (p.category || "uncategorised").toUpperCase(), Number(p.price || 0).toFixed(2), (p.description || "").slice(0, 90), (p.description || "").length > 90 ? "…" : "", this.renderEthicsBars(p)))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new buyriteView();
...
function _templateObject3() {
  const data = _taggedTemplateLiteral(["<p>You don\u2019t have any listings yet.</p>"]);
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../ProductAPI":"ProductAPI.js"}],"views/pages/questionnaire.js":[function(require,module,exports) {
"use strict";
...
class QuestionnaireView {
  ...
  async init() {
    ...
    document.title = "Your Values"; // must be signed in
    ...
    const level = Number(_Auth.default.currentUser.accessLevel);
  ...
  handleRangeChange(key, e) {
    var _e$target$value, _e$target, _e$detail;

    const raw = (_e$target$value = (_e$target = e.target) === null || _e$target === void 0 ? void 0 : _e$target.value) !== null && _e$target$value !== void 0 ? _e$target$value : (_e$detail = e.detail) === null || _e$detail === void 0 ? void 0 : _e$detail.value;
  ...
  async handleSubmit(e) {
    ...
    try {
      ...
      const updatedUser = await _UserAPI.default.updateUser(_Auth.default.currentUser._id, payload, "json"); // keep local Auth.currentUser in sync with what the server now has
      ...
      _Toast.default.show(err.message || "Problem saving preferences", "error");
...
var _default = new QuestionnaireView();
...
var _questionnaire = _interopRequireDefault(require("./views/pages/questionnaire"));
...
customElements.define("br-app-header", class AppHeader extends _litElement.LitElement {
  ...
  menuClick(e) {
    ...
    if (!anchor) return;
    const pathname = anchor.pathname;
    const appSideMenu = this.shadowRoot.querySelector(".app-side-menu"); // if no drawer (just in case), navigate directly
  ...
  render() {
    ...
    return (0, _litElement.html)(_templateObject(), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2(), this.title) : "", _Router.anchorRoute, !isLoggedIn ? (0, _litElement.html)(_templateObject3(), _Router.anchorRoute, _Router.anchorRoute) : (0, _litElement.html)(_templateObject4(), e => e.preventDefault(), currentUser && currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(currentUser.avatar) : "", currentUser && currentUser.firstName, () => (0, _Router.gotoRoute)("/profile"), () => (0, _Router.gotoRoute)("/editProfile"), isVendor ? (0, _litElement.html)(_templateObject5(), () => (0, _Router.gotoRoute)("/vendor")) : "", () => _Auth.default.signOut()), !isLoggedIn ? (0, _litElement.html)(_templateObject6(), this.menuClick, this.menuClick) : isVendor ? (0, _litElement.html)(_templateObject7(), this.menuClick, this.menuClick, this.menuClick, this.menuClick) : (0, _litElement.html)(_templateObject8(), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick), isLoggedIn ? (0, _litElement.html)(_templateObject9(), () => _Auth.default.signOut()) : "");
  }

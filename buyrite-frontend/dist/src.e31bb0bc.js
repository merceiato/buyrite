...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <br-app-header\n        title=\"Edit Profile\"\n        user=", "\n      ></br-app-header>\n      <div class=\"page-content\">\n        ", "\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([" <sl-spinner></sl-spinner> "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n              <p>\n                Updated:\n                ", "\n              </p>\n              <sl-form\n                class=\"page-form\"\n                @sl-submit=", "\n              >\n                <div class=\"input-group\">\n                  <sl-textarea\n                    type=\"text\"\n                    name=\"bio\"\n                    rows=\"4\"\n                    placeholder=\"Bio\"\n                    value=\"", "\"\n                  ></sl-textarea>\n                </div>\n\n                <div class=\"input-group\">\n                  <label>User Type</label><br />\n                  <sl-select\n                    name=\"accessLevel\"\n                    value=\"", "\"\n                  >\n                    <sl-menu-item value=\"1\">Shopper</sl-menu-item>\n                    <sl-menu-item value=\"2\">Vendor</sl-menu-item>\n                  </sl-select>\n                </div>\n\n                <div class=\"input-group\">\n                  <label>Avatar</label><br />\n                  ", "\n                </div>\n\n                <sl-button type=\"primary\" class=\"submit-btn\" submit\n                  >Update Profile</sl-button\n                >\n              </sl-form>\n            "])), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format("MMMM Do YYYY, @ h:mm a"), this.updateProfileSubmitHandler.bind(this), this.user.bio, this.user.accessLevel || 1, this.user.avatar ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n                        <sl-avatar\n                          image=\"", "/images/", "\"\n                        ></sl-avatar>\n                        <input type=\"file\" name=\"avatar\" />\n                      "])), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([" <input type=\"file\" name=\"avatar\" /> "])))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/buyrite.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _taggedTemplateLiteral(e, t) { return t || (t = e.slice(0)), Object.freeze(Object.defineProperties(e, { raw: { value: Object.freeze(t) } })); } // src/views/pages/buyrite.js
class buyriteView {
  constructor() {
    this.products = [];
    this.searchTerm = "";
  ...
  renderEthicsBars(p) {
    ...
    return (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <div class=\"buyrite-tile-ethics\">\n      <div class=\"buyrite-ethic-row\">\n        <span class=\"buyrite-ethic-label\">\n          Animal welfare (", "/5)\n        </span>\n        <sl-progress-bar\n          class=\"buyrite-ethic-bar\"\n          .value=", "\n        ></sl-progress-bar>\n      </div>\n\n      <div class=\"buyrite-ethic-row\">\n        <span class=\"buyrite-ethic-label\">\n          Humanitarian (", "/5)\n        </span>\n        <sl-progress-bar\n          class=\"buyrite-ethic-bar\"\n          .value=", "\n        ></sl-progress-bar>\n      </div>\n\n      <div class=\"buyrite-ethic-row\">\n        <span class=\"buyrite-ethic-label\">\n          Sustainability (", "/5)\n        </span>\n        <sl-progress-bar\n          class=\"buyrite-ethic-bar\"\n          .value=", "/5\n        ></sl-progress-bar>\n      </div>\n\n      <div class=\"buyrite-ethic-row\">\n        <span class=\"buyrite-ethic-label\">\n          Environmentalism (", "/5)\n        </span>\n        <sl-progress-bar\n          class=\"buyrite-ethic-bar\"\n          .value=", "\n        ></sl-progress-bar>\n      </div>\n    </div>\n  "])), safeNum(er.animalWelfare), toPct(er.animalWelfare), safeNum(er.humanitarian), toPct(er.humanitarian), safeNum(er.sustainability), safeNum(er.sustainability), safeNum(er.environmentalism), toPct(er.environmentalism));
  }
  render() {
    const filtered = this.getFilteredProducts();
    const isLoading = this.isLoading;
    const error = this.error;
    const template = (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <br-app-header\n        title=\"Buy Right\"\n        user=", "\n      ></br-app-header>\n\n      <div class=\"page-content buyrite-layout\">\n        <!-- Controls row -->\n        <section class=\"buyrite-controls\">\n          <div class=\"buyrite-control\">\n            <sl-input\n              label=\"Search key words\"\n              placeholder=\"Search products\u2026\"\n              type=\"search\"\n              clearable\n              @sl-input=", "\n            ></sl-input>\n          </div>\n\n          <div class=\"buyrite-control\">\n            <sl-select\n              label=\"Select category\"\n              value=", "\n              @sl-change=", "\n            >\n              <sl-menu-item value=\"all\">All categories</sl-menu-item>\n              <sl-menu-item value=\"grocery\">Grocery</sl-menu-item>\n              <sl-menu-item value=\"household\">Household</sl-menu-item>\n              <sl-menu-item value=\"fashion\">Fashion</sl-menu-item>\n              <sl-menu-item value=\"personal-care\">Personal Care</sl-menu-item>\n              <sl-menu-item value=\"other\">Other</sl-menu-item>\n            </sl-select>\n          </div>\n        </section>\n\n        <!-- Simple ethics question -->\n        <section class=\"buyrite-ethics-question\">\n          <p class=\"buyrite-ethics-question__text\">\n            Only show products with strong ethical credentials?\n          </p>\n          <div class=\"buyrite-ethics-question__buttons\">\n            <sl-button\n              size=\"small\"\n              variant=", "\n              @click=", "\n              >Yes</sl-button\n            >\n            <sl-button\n              size=\"small\"\n              variant=", "\n              @click=", "\n              >No</sl-button\n            >\n          </div>\n        </section>\n\n        <!-- Grid of items -->\n        <section class=\"buyrite-grid-wrapper\">\n          ", "\n        </section>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), this.handleSearchInput.bind(this), this.selectedCategory, this.handleCategoryChange.bind(this), this.ethicsStrict ? "primary" : "default", this.handleEthicsYes.bind(this), !this.ethicsStrict ? "primary" : "default", this.handleEthicsNo.bind(this), isLoading ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n                <div class=\"buyrite-loading\">\n                  <sl-spinner></sl-spinner>\n                  <p>Loading products\u2026</p>\n                </div>\n              "]))) : error ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<p class=\"error-msg\">", "</p>"])), error) : filtered.length === 0 ? (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n                <div class=\"buyrite-empty\">\n                  <p>No products match your search and filters yet.</p>\n                  ", "\n                </div>\n              "])), this.ethicsStrict ? (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["<p class=\"hint\">\n                        Tip: try turning off the ethics filter or broadening\n                        your search.\n                      </p>"]))) : "") : (0, _litHtml.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n                <div class=\"buyrite-grid\">\n                  ", "\n                </div>\n              "])), filtered.map(p => (0, _litHtml.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n                      <sl-card class=\"buyrite-tile\">\n                        ", "\n\n                        <h3 slot=\"header\" class=\"buyrite-tile-title\">\n                          ", "\n                        </h3>\n\n                        <div class=\"buyrite-tile-meta\">\n                          <span class=\"buyrite-tile-category\">\n                            ", "\n                          </span>\n                          <span class=\"buyrite-tile-price\">\n                            $", "\n                          </span>\n                        </div>\n\n                        <p class=\"buyrite-tile-description\">\n                          ", "", "\n                        </p>\n\n                        ", "\n                      </sl-card>\n                    "])), p.image ? (0, _litHtml.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n                              <img\n                                slot=\"image\"\n                                src=\"", "/images/", "\"\n                                alt=\"", "\"\n                              />\n                            "])), _App.default.apiBase, p.image, p.title) : "", p.title, (p.category || "uncategorised").toUpperCase(), Number(p.price || 0).toFixed(2), (p.description || "").slice(0, 90), (p.description || "").length > 90 ? "…" : "", this.renderEthicsBars(p)))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new buyriteView();
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../ProductAPI":"ProductAPI.js"}],"views/pages/vendorHome.js":[function(require,module,exports) {
"use strict";
...
class VendorHomeView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <br-app-header\n        title=\"Vendor Dashboard\"\n        user=", "\n      ></br-app-header>\n\n      <div class=\"page-content\">\n        <h2>Welcome, ", "</h2>\n        <p>Role: Vendor</p>\n        <p>\n          Last updated:\n          ", "\n        </p>\n\n        <div class=\"vendor-grid\">\n          <sl-card class=\"vendor-card\">\n            <h3 slot=\"header\">Manage Products</h3>\n            <p>\n              Add, edit and organise the products you make available to\n              shoppers.\n            </p>\n            <sl-button\n              @click=", "\n              variant=\"primary\"\n            >\n              Go to Products\n            </sl-button>\n          </sl-card>\n\n          <sl-card class=\"vendor-card\">\n            <h3 slot=\"header\">Brand Profile</h3>\n            <p>Tell shoppers about your brand, values and certifications.</p>\n            <sl-button @click=", " variant=\"default\">\n              Edit Brand Profile\n            </sl-button>\n          </sl-card>\n\n          <sl-card class=\"vendor-card\">\n            <h3 slot=\"header\">Insights (placeholder)</h3>\n            <p>\n              In the future this area can show engagement and performance data.\n            </p>\n          </sl-card>\n        </div>\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, (0, _moment.default)(_Auth.default.currentUser.updatedAt).format("MMMM Do YYYY, @ h:mm a"), () => (0, _Router.gotoRoute)("/vendor/manageProducts"), () => (0, _Router.gotoRoute)("/profile"));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new VendorHomeView();
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","moment":"../node_modules/moment/moment.js"}],"views/pages/vendorManageListings.js":[function(require,module,exports) {
"use strict";
...
class vendorPreviewItemsView {
  ...
  render() {
    ...
    const isLoading = this.isLoading;
    const error = this.error;
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <br-app-header\n        title=\"Preview Items\"\n        user=", "\n      ></br-app-header>\n\n      <div class=\"page-content preview-layout\">\n        ", "\n      </div>\n    "])), JSON.stringify(_Auth.default.currentUser), isLoading ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n              <div class=\"preview-loading\">\n                <sl-spinner></sl-spinner>\n                <p>Loading your items\u2026</p>\n              </div>\n            "]))) : error ? (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<p class=\"error-msg\">", "</p>"])), error) : items.length === 0 ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n              <div class=\"preview-empty\">\n                <h2>No items yet</h2>\n                <p>\n                  You haven't created any products. Create one from the Manage\n                  Items page.\n                </p>\n                <sl-button variant=\"primary\" @click=", ">\n                  Go to Manage Items\n                </sl-button>\n              </div>\n            "])), this.gotoCreateListing) : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n              <!-- LEFT: list of items -->\n              <section class=\"preview-list-panel\">\n                <header class=\"preview-list-header\">\n                  <h2>Your items</h2>\n                  <!-- changed plus-lg -> plus -->\n                  <sl-icon-button\n                    name=\"plus\"\n                    label=\"Create listing\"\n                    @click=", "\n                  ></sl-icon-button>\n                </header>\n\n                <ul class=\"preview-list\">\n                  ", "\n                </ul>\n              </section>\n\n              <!-- RIGHT: full preview of selected item -->\n              <section class=\"preview-detail-panel\">\n                <h2>Customer view</h2>\n\n                ", "\n              </section>\n            "])), this.gotoCreateListing, items.map(l => (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n                      <li\n                        class=\"preview-list-item ", "\"\n                        @click=", "\n                      >\n                        <div class=\"preview-list-thumb\">\n                          ", "\n                        </div>\n\n                        <div class=\"preview-list-text\">\n                          <div class=\"preview-list-title\">\n                            ", "\n                          </div>\n                          <div class=\"preview-list-meta\">\n                            <span class=\"preview-list-category\">\n                              ", "\n                            </span>\n                            <span class=\"preview-list-price\">\n                              $", "\n                            </span>\n                          </div>\n                        </div>\n\n                        <div class=\"preview-list-actions\">\n                          <!-- changed pencil-square -> pencil -->\n                          <sl-icon-button\n                            name=\"pencil\"\n                            label=\"Edit listing\"\n                            @click=", "\n                          ></sl-icon-button>\n                        </div>\n                      </li>\n                    "])), selected && selected._id === l._id ? "is-active" : "", () => this.handleSelectListing(l), l.image ? (0, _litHtml.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n                                <img\n                                  src=\"", "/images/", "\"\n                                  alt=\"", "\"\n                                />\n                              "])), _App.default.apiBase, l.image, l.title) : (0, _litHtml.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["<div class=\"preview-list-thumb--placeholder\">\n                                No image\n                              </div>"]))), l.title || "Untitled listing", (l.category || "uncategorised").toUpperCase(), Number(l.price || 0).toFixed(2), e => this.gotoEditListing(e, l))), !selected ? (0, _litHtml.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["<p>Select an item on the left to preview it.</p>"]))) : (0, _litHtml.html)(_templateObject0 || (_templateObject0 = _taggedTemplateLiteral(["\n                      <sl-card class=\"preview-detail-card\">\n                        ", "\n\n                        <div class=\"preview-detail-header\" slot=\"header\">\n                          <div>\n                            <h3>", "</h3>\n                            <div class=\"preview-detail-tags\">\n                              <span class=\"chip\">\n                                ", "\n                              </span>\n                            </div>\n                          </div>\n                          <div class=\"preview-detail-price\">\n                            $", "\n                          </div>\n                        </div>\n\n                        <p>", "</p>\n\n                        <div slot=\"footer\" class=\"preview-detail-footer\">\n                          <small>\n                            This is a preview of how shoppers will see this\n                            product in the customer interface.\n                          </small>\n                        </div>\n                      </sl-card>\n                    "])), selected.image ? (0, _litHtml.html)(_templateObject1 || (_templateObject1 = _taggedTemplateLiteral(["\n                              <img\n                                slot=\"image\"\n                                src=\"", "/images/", "\"\n                                alt=\"", "\"\n                              />\n                            "])), _App.default.apiBase, selected.image, selected.title) : "", selected.title || "Untitled listing", (selected.category || "uncategorised").toUpperCase(), Number(selected.price || 0).toFixed(2), this.getShortDescription(selected.description))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
var _default = exports.default = new vendorPreviewItemsView();
...
var _buyrite = _interopRequireDefault(require("./views/pages/buyrite"));
...
customElements.define("br-app-header", class AppHeader extends _litElement.LitElement {
  ...
  render() {
    ...
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <style>\n          * {\n            box-sizing: border-box;\n          }\n\n          .app-header {\n            background: var(--brand-color);\n            position: fixed;\n            top: 0;\n            right: 0;\n            left: 0;\n            height: var(--app-header-height);\n            color: #fff;\n            display: flex;\n            align-items: center;\n            z-index: 9;\n            box-shadow: 4px 0px 10px rgba(0, 0, 0, 0.2);\n          }\n\n          .app-header:focus {\n            outline: none;\n          }\n\n          /* \u2605 Centered logo */\n          .app-header-logo {\n            position: absolute;\n            left: 50%;\n            transform: translateX(-50%);\n            z-index: 5;\n            pointer-events: none; /* allow clicks to nav behind it */\n          }\n\n          .app-header-logo img {\n            height: 15vh;\n            width: auto;\n            display: block;\n          }\n\n          .app-header-main {\n            flex-grow: 1;\n            display: flex;\n            align-items: center;\n          }\n\n          .app-logo img {\n            width: 90px;\n          }\n\n          .hamburger-btn::part(base) {\n            color: #fff;\n          }\n\n          .app-top-nav {\n            display: flex;\n            height: 100%;\n            align-items: center;\n          }\n\n          .app-top-nav a {\n            display: inline-block;\n            padding: 0.8em;\n            text-decoration: none;\n            color: #fff;\n          }\n\n          .app-side-menu-items {\n            padding-top: 150px;\n          }\n\n          .app-side-menu-items a {\n            display: block;\n            padding: 0.8em;\n            text-decoration: none;\n            font-size: 1.3em;\n            color: #333;\n          }\n\n          .app-side-menu-items a + a {\n            margin-top: 0.3em;\n          }\n\n          .app-side-menu-logo {\n            width: 120px;\n            margin-bottom: 1em;\n            position: absolute;\n            top: 2em;\n            left: 1.5em;\n          }\n\n          .page-title {\n            color: var(--app-header-txt-color);\n            margin-right: 0.5em;\n            font-size: var(--app-header-title-font-size);\n          }\n\n          .app-top-nav a.active,\n          .app-side-menu-items a.active {\n            font-weight: bold;\n          }\n\n          @media all and (max-width: 768px) {\n            .app-top-nav {\n              display: none;\n            }\n          }\n        </style>\n\n        <header class=\"app-header\" tabindex=\"-1\">\n          <sl-icon-button\n            class=\"hamburger-btn\"\n            name=\"list\"\n            @click=\"", "\"\n            style=\"font-size: 1.5em;\"\n          ></sl-icon-button>\n\n          <!-- \u2605 centered logo -->\n          <div class=\"app-header-logo\">\n            <img src=\"/images/logo.svg\" alt=\"BuyRight\" />\n          </div>\n\n          <div class=\"app-header-main\">\n            ", "\n            <slot></slot>\n          </div>\n\n          <nav class=\"app-top-nav\">\n            <a href=\"/\" @click=\"", "\">Home</a>\n\n            ", "\n          </nav>\n        </header>\n\n        <sl-drawer class=\"app-side-menu\" placement=\"left\">\n          <img class=\"app-side-menu-logo\" src=\"/images/logo.svg\" />\n          <nav class=\"app-side-menu-items\">\n            ", "\n            ", "\n          </nav>\n        </sl-drawer>\n      "])), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<h1 class=\"page-title\">", "</h1>"])), this.title) : "", _Router.anchorRoute, !isLoggedIn ? (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n                  <a href=\"/signin\" @click=\"", "\">Sign In</a>\n                  <a href=\"/signup\" @click=\"", "\">Sign Up</a>\n                "])), _Router.anchorRoute, _Router.anchorRoute) : (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n                  <sl-dropdown>\n                    <a\n                      slot=\"trigger\"\n                      href=\"#\"\n                      @click=\"", "\"\n                    >\n                      <sl-avatar\n                        style=\"--size: 24px;\"\n                        image=", "\n                      ></sl-avatar>\n                      ", "\n                    </a>\n                    <sl-menu>\n                      <sl-menu-item @click=\"", "\"\n                        >Account</sl-menu-item\n                      >\n                      <sl-menu-item @click=\"", "\"\n                        >Edit Profile</sl-menu-item\n                      >\n                      ", "\n                      <sl-menu-item @click=\"", "\"\n                        >Sign Out</sl-menu-item\n                      >\n                    </sl-menu>\n                  </sl-dropdown>\n                "])), e => e.preventDefault(), currentUser && currentUser.avatar ? "".concat(_App.default.apiBase, "/images/").concat(currentUser.avatar) : "", currentUser && currentUser.firstName, () => (0, _Router.gotoRoute)("/profile"), () => (0, _Router.gotoRoute)("/editProfile"), isVendor ? (0, _litElement.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n                            <sl-menu-item @click=\"", "\"\n                              >Vendor Dashboard</sl-menu-item\n                            >\n                          "])), () => (0, _Router.gotoRoute)("/vendor")) : "", () => _Auth.default.signOut()), !isLoggedIn ? (0, _litElement.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n                  <a href=\"/signin\" @click=\"", "\">Sign In</a>\n                  <a href=\"/signup\" @click=\"", "\">Sign Up</a>\n                "])), this.menuClick, this.menuClick) : isVendor ? (0, _litElement.html)(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n                  <a href=\"/vendor\" @click=\"", "\">\n                    Vendor Dashboard\n                  </a>\n                  <a href=\"/vendor/manageProducts\" @click=\"", "\">\n                    Manage Listings\n                  </a>\n                  <a href=\"/vendor/previewProducts\" @click=\"", "\">\n                    Preview Items\n                  </a>\n                  <a href=\"/about\" @click=\"", "\">\n                    About & Support\n                  </a>\n                "])), this.menuClick, this.menuClick, this.menuClick, this.menuClick) : (0, _litElement.html)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n                  <a href=\"/\" @click=\"", "\">Home</a>\n                  <a href=\"/buyrite\" @click=\"", "\">\n                    Consumer Interface\n                  </a>\n                  <a href=\"/guide\" @click=\"", "\">\n                    Questionnaire\n                  </a>\n                  <a href=\"/favouriteHaircuts\" @click=\"", "\">\n                    Saved Items\n                  </a>\n                  <a href=\"/about\" @click=\"", "\">\n                    About & Support\n                  </a>\n                "])), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick), isLoggedIn ? (0, _litElement.html)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral([" <a href=\"#\" @click=\"", "\">Sign Out</a> "])), () => _Auth.default.signOut()) : "");
  }
});
